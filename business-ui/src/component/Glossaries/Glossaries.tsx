    ...
    >
      ...
      >
        ...
        >
              ...
              {(
                <>
                  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    ...
                    <ThemedIconContainer iconColor={GLOSSARY_COLORS[displayItem?.type || "term"]}>
                      {getIcon(displayItem?.type || "term", "medium")}
                    </ThemedIconContainer>
                  </div>
                  <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "20px", flexWrap: "wrap" }}>
                      <Tooltip title={displayItem?.displayName || ''} arrow placement="top">
                        <label style={{
                          fontFamily: '"Google Sans", sans-serif',
                              color: "#1F1F1F",
                              fontSize: "24px",
              ...
              <div style={{ width: "100%" }}>
                {displayItem.description ? (
                  <>
                    ...
                    {(displayItem.description).trim().length > 600 && (
                      <button
          ...
          {/* Tabs */}
          {(displayItem && !displayItem.aspects && accessDeniedItemId !== selectedId) ||
          (displayItem?.type === "term" && !displayItem.relations && accessDeniedItemId !== selectedId) ? (
        ...
        {displayItem ? (
          <Box sx={{ p: "0px 20px 20px 20px", pt: tabValue !== 0 ? "20px" : "0px", overflowY: "hidden", flex: 1 }}>
            {tabValue === 0 && (
              ...
              >
                <DetailPageOverview
                  entry={transformGlossaryToEntry(displayItem)}
                  css={{ width: "100%" }}
            ...
            {isTerm && tabValue === 3 && (
              <GlossariesLinkedAssets
                linkedAssets={displayItem.linkedAssets || []}
                searchTerm={contentSearchTerm}
                onSearchTermChange={setContentSearchTerm}
                idToken={user?.token || ""}
                ...
                {hasVisibleAspects ? (
                  ...
                  >
                    ...
                    <Box sx={{ 
                      ...
                      <PreviewAnnotation
                        entry={filteredAnnotationEntry || displayItem}
                        css={{
                          border: "none",
                          margin: 0,
